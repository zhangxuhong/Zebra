...
public class TestCheckpoint extends TestCase {
  ...
  public static class TestMessageManager implements MessageManager<Text> {
    ...
    @Override
    public final Text getCurrentLocalMessage() throws IOException {
      //return localMsgQueue.poll();
      return null;
    }
    ...
    @Override
    public void send(Text msg) throws IOException {
  ...
  public static class TestBSPPeer implements
    ...
    @Override
    public Text getCurrentLocalMessage() throws IOException {
      return new Text("data");
    }
