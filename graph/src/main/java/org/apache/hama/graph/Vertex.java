...
public abstract class Vertex<V extends Writable, E extends Writable, M extends Writable>
  ...
  //private List<Edge<V, E>> remoteEdges;
/**************************************************************/
...
/********************************************modified**************************/
  ...
  public void sendMessage(Edge<V, E> e, M msg) throws IOException {
    String DestinationPeerName = getDestinationPeerName(e.getPartitionID().get());
    if(DestinationPeerName.equals(runner.getPeer().getPeerName())){
      runner.getPeer().send(new GraphJobMessage(e.getDestinationVertexID(), msg));
    }
    else{
      runner.getPeer().send(DestinationPeerName,
  ...
  public String getDestinationPeerName(int id){
    return runner.getPeer().getPeerName(id);
  }
...
/******************************************maybe need to add local msg processing*******************************************/
  @Override
